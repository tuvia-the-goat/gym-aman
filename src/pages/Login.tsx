      ...
      <div className="glass max-w-md w-full p-8 rounded-2xl animate-fade-up">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button
            ...
            transition duration-300 hover:bg-primary/90 hover:shadow-lg flex items-center justify-center"
            disabled={loading}
          >
            {loading ? (
          ...
          <div className="text-center text-sm text-muted-foreground mt-4">
            <p>משתמשים לבדיקה:</p>
            <p>מנהל כללי: allBasesAdmin / 12345</p>
            <p>מנהל מכון: gymAdmin / 12345</p>
          </div>
        </form>
      </div>
    </div>
